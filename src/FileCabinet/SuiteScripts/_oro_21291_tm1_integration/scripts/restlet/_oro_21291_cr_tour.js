                ...
                tourData.forEach((tour) => {
                    ...
                    try {
                        ...
                        if (tour.DepartureDate && tour.ReturnDate) {
                            ...
                            recTour.setValue('custrecord_oro_tour_loc', tour.TourLocation ? lib.findListValue(tour.TourLocation, 'customrecord_oro_location') : '', true);
                            recTour.setValue('custrecord_oro_tour_loc_name', tour.TourLocationName);
                            recTour.setValue('custrecord_oro_tour_reg_name', tour.TourRegionName ? lib.findListValueCached(tour.TourRegionName, 'customrecord_oro_region') : '', true);
                            recTour.setValue('custrecord_oro_tour_glo_reg_name', tour.TourGlobalRegionName ? lib.findListValueCached(tour.TourGlobalRegionName, 'customrecord_oro_region') : '', true);
                            recTour.setValue('custrecord_oro_tour_reg', tour.TourRegion);
                            recTour.setValue('custrecord_oro_tour_glo_reg', tour.TourGlobalRegion);
                            recTour.setValue('custrecord_oro_tour_ops', tour.OpsGroup ? lib.findListValueCached(tour.OpsGroup, 'customrecord_oro_21k_opsgroup') : '', true);
                            recTour.setValue('custrecord_oro_tour_journey', tour.JourneyMode ? lib.findListValueCached(tour.JourneyMode, 'customrecord_oro_21k_journeymode') : '', true);
                            ...
                            recTour.setValue('custrecord_oro_tour_extension', tour.IsExtension);
