            ...
            try {
                ...
                customerData.forEach((customer) => {
                    ...
                    try {
                        ...
                        var agentCountry = '';
                        if (customer.AgentCountry) {
                            if (lib.countryByCode(customer.AgentCountry)[0]) {
                                agentCountry = lib.countryByCode(customer.AgentCountry)[0].id;
                            }
                        }
                        ...
                        if ((customer.Individual && customer.FirstName && customer.LastName) || (!customer.Individual && customer.CompanyName)) {
                            ...
                            recCustomer.setValue('custentity_oro_21_book_agent_address_1', customer.AgentAddress1);
                            recCustomer.setValue('custentity_oro_21_book_agent_address_2', customer.AgentAddress2);
                            recCustomer.setValue('custentity_oro_21_book_agent_suburb', customer.AgentSuburb);
                            recCustomer.setValue('custentity_oro_21_book_agent_state', customer.AgentState);
                            recCustomer.setValue('custentity_oro_21_book_agent_country', agentCountry);
                            recCustomer.setValue('custentity_oro_21_book_agent_zip', customer.AgentPostCode);
                            recCustomer.setValue('custentity_oro_21_book_agent_phone', customer.AgentPhone);
                            recCustomer.setValue('custentity_oro_21_book_agent_fax', customer.AgentFax);
                            recCustomer.setValue('custentity_oro_21_book_agent_email', customer.AgentEmail);
                            ...
                            recCustomer.setValue('custentity_oro_21_book_agent_type', customer.AgentTypeID);
                            recCustomer.setValue('custentity_oro_21_book_agent_code', customer.AgentCode);
                            recCustomer.setValue('custentity_oro_21_book_agent_name', customer.AgentName);
                            recCustomer.setValue('custentity_oro_21_book_agent_consortia', customer.AgentConsortia);
